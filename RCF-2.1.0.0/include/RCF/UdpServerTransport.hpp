...
//----------------------------------------------------------------
	class MQServerTransport;
	class MQNetworkSession;

	typedef boost::shared_ptr<MQServerTransport>   MQServerTransportPtr;
	typedef boost::shared_ptr<MQNetworkSession>      MQNetworkSessionPtr;

	class RCF_EXPORT MQNetworkSession : public NetworkSession
	{
	public:

		MQNetworkSession(MQServerTransport & transport);

		int                        getNativeHandle() const;

		typedef MQNetworkSessionPtr NetworkSessionPtr;
		
		void SetMessage(void *pStr, int iSize);
		ReallocBufferPtr GetResult();
	...
	private:
		...
		ReallocBufferPtr                            mWriteVecPtr;
		IpAddress                                   mRemoteAddress;
		MQServerTransport &                        mTransport;
		SessionPtr                                  mRcfSessionPtr;

		friend class MQServerTransport;
	...
	class RCF_EXPORT MQServerTransport :
		public ServerTransport,
		public IpServerTransport,
		public I_Service,
		boost::noncopyable
	...
	private:
		...
		typedef MQNetworkSession NetworkSession;
		typedef MQNetworkSessionPtr NetworkSessionPtr;
	...
	public:
		...
		MQServerTransport & enableSharedAddressBinding();
