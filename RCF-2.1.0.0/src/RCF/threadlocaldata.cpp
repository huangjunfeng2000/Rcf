...
namespace RCF {
    ...
    public:
        ...
        MQNetworkSessionPtr              mMQNetworkSessionPtr;
	...
	MQNetworkSessionPtr getTlsMQNetworkSessionPtr()
	{
		ThreadLocalData & tld = getThreadLocalData();
		return tld.mMQNetworkSessionPtr;
	}

	void setTlsMQNetworkSessionPtr(MQNetworkSessionPtr udpNetworkSessionPtr)
	{
		ThreadLocalData & tld = getThreadLocalData();
		tld.mMQNetworkSessionPtr = udpNetworkSessionPtr;
	}
